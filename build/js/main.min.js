...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var filterListSearch = document.getElementById('filter-category').querySelectorAll('.filter-item');
  var filterList = document.querySelectorAll('.filter-item');
  var selectedContainer = document.querySelector('.selected-items');
  filterInput.addEventListener('input', function () {
    var searchTerm = filterInput.value.toLowerCase();
    filterListSearch.forEach(function (item) {
  ...
  var dateInputField = document.querySelector('.date-input__field');
  var dateInputBtn = document.querySelector('.date-input__btn');
...
},{"./modules/accordion/init-accordion":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./utils/ios-vh-fix":16,"imask":1}],3:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":14,"../../utils/scroll-lock":17}],14:[function(require,module,exports){
"use strict";
