...
var _niceSelect2 = _interopRequireDefault(require("./../js/vendor/nice-select2"));
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function filterItems() {
    ...
    var selectedDateRanges = Array.from(document.querySelector('input[name="date"]:checked')).map(function (input) {
      return input.value;
    });
    var visibleItems = 0;
    competitionItems.forEach(function (item) {
      ...
      var matchesRegion = customSelectInput.value.length === 0 || customSelectInput.value === region;
  ...
  if (select) {
    var _niceSelect = new _niceSelect2.default(select, {
      searchable: true,
